...
<div class="easyui-layout" style="width:645px;height:280px;">
	...
	<div data-options="region:'south',fit:true,border:false"> 
		<fieldset style="border-radius: 3px;height:116px;">
			...
			<table style="height: 100px;">
				<tbody>
					...
					<tr>
						<td><input type="text" style="width:73px;" name="v_second" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_min" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_hour" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_day" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_mouth" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_week" class="col" value="?" readonly="readonly"/></td>
						<td><input type="text" style="width:73px;" name="v_year"  class="col" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>Cron表达式:
						</td>
						<td colspan="7"><input type="text" name="cron_expression" style="width:99.3%;" value="* * * * * ? " id="cron" readonly="readonly"/></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
