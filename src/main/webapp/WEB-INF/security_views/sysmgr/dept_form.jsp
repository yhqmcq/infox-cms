...
<script type="text/javascript">
	var form_url = siteUtil.basePath+"/sysmgr/deptAction/add.do" ;
	
	$(function() {
		$("#select1").combotree({
			url : siteUtil.basePath+"/sysmgr/deptAction/treegrid.do",
		...
		if($('input[name=id]').val().length > 0) {
			form_url = siteUtil.basePath+"/sysmgr/deptAction/edit.do" ;
			$.post(siteUtil.basePath+"/sysmgr/deptAction/get.do", {id:$('input[name=id]').val()}, function(result) {
...
<form id="form" class="easyui-form">
	...
	<div class="form_base">
		<table>
			<tr>
				<th>部门名称：</th>
				<td><input name="name" class="easyui-validatebox" type="text" data-options="required: true,prompt: '部门名称'" /></td>
			</tr>
			<tr>
				<th>电话：</th>
			...
			<tr>
				...
				<th>上级部门：</th>
				<td><input id="select2" name="company_id" /></td>
			</tr>
			<tr>
				<td colspan="4">
