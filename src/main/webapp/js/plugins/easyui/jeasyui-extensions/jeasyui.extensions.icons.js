    ...
    $.easyui.icons.showSelector = function (options) {
        ...
        var value = opts.selected,
            dia = $.easyui.showDialog($.extend({}, opts, {
                content: "<style>.panel-body  { overflow: auto; }</style><div class=\"icons-layout\"><div data-options=\"region: 'north', split: false, border: false\" style=\"height: 31px; overflow: hidden;\"><div class=\"icons-toolbar\"></div></div><div data-options=\"region: 'center', border: false\"><div class=\"icons-tabs\"></div></div></div>",
                saveButtonText: "确定",
