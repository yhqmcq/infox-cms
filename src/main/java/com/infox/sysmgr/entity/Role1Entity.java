 ...
 */
@Entity
@Table(name = "INFOX_SYSMGR_ROLE1")
@DynamicUpdate(true)
@DynamicInsert(true)
public class Role1Entity implements Serializable {
	...
	@JoinColumn(name = "PID")
	public Role1Entity getRole() {
		return role;
	}

	public void setRole(Role1Entity role) {
		this.role = role;
	}
