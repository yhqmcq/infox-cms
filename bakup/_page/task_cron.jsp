...
<script src="${pageContext.request.contextPath}/js/plugins/other/cron.js" type="text/javascript"></script>
<style>
...
<div class="easyui-layout" style="width:645px;height:285px;border:0px rgb(202, 196, 196) solid;">
	<div data-options="region:'center',border:false">
		<div class="easyui-tabs" data-options="fit:true,border:false">
			...
			<div data-options="title: '分', refreshable: false,selected:true">
			...
			<div data-options="title: '小时', refreshable: false,selected:true">
			...
			<div data-options="title: '日', refreshable: false,selected:true">
			...
			<div data-options="title: '月', refreshable: false,selected:true">
			...
			<div data-options="title: '周', refreshable: false,selected:true">
			...
			<div data-options="title: '年', refreshable: false,selected:true">
	...
	<div data-options="region:'south',fit:true,border:false" style="height:230px">
		<fieldset style="border-radius: 3px;height:116px;">
			...
			<table style="height: 100px;">
				<tbody>
					...
					<tr>
						<td>表达式字段:</td>
						<td><input type="text" style="width:65px;" name="v_second" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_min" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_hour" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_day" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_mouth" class="col" value="*" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_week" class="col" value="?" readonly="readonly"/></td>
						<td><input type="text" style="width:65px;" name="v_year"  class="col" readonly="readonly"/></td>
					</tr>
					<tr>
						<td>Cron表达式:
						</td>
						<td colspan="7"><input type="text" name="cron" style="width:99.2%;" value="* * * * * ? " id="cron" readonly="readonly"/></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
